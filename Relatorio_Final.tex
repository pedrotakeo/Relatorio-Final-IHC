...
\begin{enumerate}
    ...
    \item Muitas páginas têm botões sem nenhuma formatação que deixa explicito que algo é um botão. Esses botões parecem ser texto não reativo e deixam o aplicativo confuso. A tela inicial de escolha de ônibus da seção dp Intercampi tem esse problema de forma mais evidente.
    ...
    \item O usuário é automaticamente deslogado ao sair da apliação, não havendo um tolkien para manter o login por certo tempo, coisa que gera uma maior carga de trabalho para o usuário, demandando mais tempo e complexidade toda vez que for logar sua conta.
